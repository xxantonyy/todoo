    ...
    <div className={b()}>
      ...
      <div className={b('news')}>
        <div className={b('item')}>
          ...
          <div>✅ 2 - Был исправлен баг с фильтром, при смене статуса фильтр сбрасывался и задачи получались по новой, теперь фильтр не сбрасывается и запоминается состояние фильтра между обновлениями </div>
        </div>
      </div>
